...
def _get_base_config(config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        **config,
        ...
        """
        TODO: openai代理调用方式
        "api_key": "sk-Jw5600oqkmCnRE4R17Bd2c8a350245AaBf5fDfE5Dd748f83", #TODO: api_key,
        "api_base": "https://api.xiaoai.plus/v1", #TODO: config.get("api_base"),
        "api_version": "gpt-4o-mini", #TODO: config.get("api_version"),
        """
